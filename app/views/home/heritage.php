...
<section class="py-24 px-8 md:px-16 max-w-7xl mx-auto relative z-20">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
        ...
        <div class="lg:col-span-6 space-y-8 text-left">
            ...
            <div class="space-y-6 text-sm md:text-base text-gray-400 font-light leading-relaxed tracking-wide editorial-content">
                <?= $bodyContent; ?>
            </div>
        </div>
        ...
        <div class="lg:col-span-6">
            <div class="relative aspect-[4/5] max-w-lg mx-auto bg-surface rounded-2xl overflow-hidden border border-borderGray shadow-2xl p-4 flex items-center justify-center group">
                ...
                <img src="<?= htmlspecialchars($imgUrl); ?>" alt="<?= htmlspecialchars($headline); ?>" class="w-full h-full object-cover rounded-xl transform group-hover:scale-105 transition-transform duration-700 z-0">
            </div>
        </div>
